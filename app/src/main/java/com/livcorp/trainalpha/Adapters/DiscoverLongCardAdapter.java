...
public class DiscoverLongCardAdapter extends RecyclerView.Adapter<DiscoverLongCardAdapter.viewHolder> {

    ArrayList<CardModel> list;
    Context context;
    Dialog dialog;

    public DiscoverLongCardAdapter(ArrayList<CardModel> list, Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_recyclerview_long, parent, false);
        return new DiscoverLongCardAdapter.viewHolder(view);
    }
